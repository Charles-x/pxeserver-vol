...
RUN wget -P /pxe https://github.com/Charles-x/pxeserver-vol/blob/master/pxe/pxelinux.0.pxe --no-check-certificate
RUN wget -P /pxe https://github.com/Charles-x/pxeserver-vol/blob/master/pxe/gpxelinux.0.gpxe --no-check-certificate
